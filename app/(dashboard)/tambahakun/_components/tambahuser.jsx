...
const UserTable = () => {
  ...
  const users = [
    { id: "10XXXXX", name: "Martin Anisa Abigail Uhuy", dob: "DD/MM/YYYY", gender: "Wanita", phone: "+62xxxxxxxx", class: "VI A", major: "IPA", year: 2018, status: "Active", password: "1234" },
    { id: "10XXXXX", name: "Taka Teke Rumba", dob: "DD/MM/YYYY", gender: "Wanita", phone: "+62xxxxxxxx", class: "VI A", major: "IPS", year: 2018, status: "Active", password: "1234" },
    { id: "10XXXXX", name: "Akio Anak Baiq", dob: "DD/MM/YYYY", gender: "Pria", phone: "+62xxxxxxxx", class: "V B", major: "Non", year: 2019, status: "Active", password: "1234" },
  ];
